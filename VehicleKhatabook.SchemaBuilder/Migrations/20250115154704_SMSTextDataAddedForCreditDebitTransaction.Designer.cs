...
namespace VehicleKhatabook.SchemaBuilder.Migrations
{
    ...
    [Migration("20250115154704_SMSTextDataAddedForCreditDebitTransaction")]
    partial class SMSTextDataAddedForCreditDebitTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VehicleKhatabook.Entities.Models.ApplicationConfiguration", b =>
                {
                    ...
                    b.Property<string>("AdShowOnPage")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("CreditTransactionSmsText")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DebitTransactionSmsText")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SubscriptionDurationDays")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SubscriptionIsRenewable")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SubscriptionName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SubscriptionRenewalReminderDaysBefore")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SubscriptionTrialPeriodDays")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("VehicleKhatabook.Entities.Models.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VehicleKhatabook.Entities.Models.PaymentHistory", b =>
                {
            ...
            modelBuilder.Entity("VehicleKhatabook.Entities.Models.SubscriptionMaster", b =>
                {
            ...
            modelBuilder.Entity("VehicleKhatabook.Entities.Models.District", b =>
                {
                    b.HasOne("VehicleKhatabook.Entities.Models.State", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("VehicleKhatabook.Entities.Models.PaymentHistory", b =>
                {
                    b.HasOne("VehicleKhatabook.Entities.Models.SubscriptionMaster", "Subscription")
