...
namespace VehicleKhatabook.Services.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<(bool Success, OtpRequest Otp)> SendOTPforRegisteredUser(string mobileNumber, string SmsPurpose, string app_signature)
        {
            ...
            if (user != null)
            {
                ...
                await _otpRepository.SendOtpAsync(mobileNumber, otp, SmsPurpose, app_signature);
        ...
        public async Task<(bool Success, OtpRequest Otp)> SendOTPforAnonymousUser(string mobileNumber, string SmsPurpose, string app_signature)
        {
