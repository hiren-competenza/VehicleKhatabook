...
namespace VehicleKhatabook.Services.Services
{
    public class FuelTrackingService : IFuelTrackingService
    {
        ...
        //public async Task<FuelTracking> AddFuelTrackingAsync(MileageInputDTO fuelTrackingDTO)
        //{
        ...
        //public async Task<ApiResponse<FuelTracking>> UpdateFuelTrackingAsync(Guid id, MileageInputDTO fuelTrackingDTO)
        //{
